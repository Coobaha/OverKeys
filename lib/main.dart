...
Future<void> _createPreferencesWindow() async {
  ...
  await windowManager.waitUntilReadyToShow(windowOptions, () async {
    ...
    final String iconPath = Platform.isWindows ? "assets/images/app_icon.ico" : "assets/images/app_icon.png";
    ...
    final screenBounds = MediaQueryData.fromView(WidgetsBinding.instance.platformDispatcher.views.first).size;
    ...
    await windowManager.setPosition(Offset(xPosition.clamp(50, screenBounds.width - windowSize.width - 50), 50));
...
Future<void> _createMultiWindowPreferences(int windowId) async {
  ...
  runApp(MaterialApp(
    ...
    home: PreferencesScreen(windowController: WindowController.fromWindowId(windowId)),
    debugShowCheckedModeBanner: false,
  ));
}
...
void main(List<String> args) async {
  ...
  if (isSubWindow) {
    ...
    WindowOptions windowOptions = Platform.isMacOS ? WindowOptions(
      skipTaskbar: true,
      title: "OverKeys",
